...
nodos = {}
pend_dormir  = set()   # ids marcados para dormir (se confirma al despertar)
pend_activar = set()   # ids marcados para activar
...
def orden(accion, nombre):
    ...
    if accion.startswith("Solicitar"):
        ...
        for n in objetivos:
            ...
            if n in nodos: nodos[n]["dormido"] = False   # ← marca ya
