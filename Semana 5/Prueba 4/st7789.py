# st7789.py — Driver híbrido para TTGO T-Display 135x240
# Basado en st7789py (Russ Hughes) + write unificado con cursor
# Solo soporta 135x240. Sin framebuffer de bandas, directo a SPI.
