...
TELEGRAM = False 
TG_TOKEN = "8621388508:AAGIk5MYdcg2wuRyGBBqeHaCDsJKdHXSiRI"
TG_CHAT  = "1182773108"
...
def pantalla_monitor():
    ...
    if info.get("dormido"): enc += " ZZZ"
    if info.get("alert"):   enc += " !" + info["alert"]
...
M.iniciar()
M.escanear_canal(1800)   # siempre arranca buscando el canal del master
