# sensores.py — Módulo de sensores unificado (plantilla de nodo)
# Reemplaza a: mpu6050.py, mlx90614.py, i2c_recovery.py
#
# Un nodo declara qué sensores tiene; el módulo confirma cuáles responden
# y lee solo esos. Así la misma plantilla sirve para domótica, biomédica,
# agricultura, etc. — solo cambian los flags.
#
# Uso típico:
#   from sensores import Sensores
#   sen = Sensores(usar_gy=True, usar_dht=True, usar_mq=True, usar_mpu=True)
#   activos = sen.detectar()          # ['MPU','GY906','DHT11','MQ135']
#   med, lec = sen.leer()             # med = [{"t","v"},...] listo para FB
#
# Compatibilidad: leer_todo() sigue existiendo para el Nodo A actual.
