...
REDES = [
    ("Totalplay-C5AC", "C5AC642BDVePRn6Z"),
    ("Arte_Tenda2.4",  "Lab4rt3#"),
    ("Xiaomi_667C",  "DhDTGJF7Fq5nNFQH"),
    # ("RedUni",       "claveuni"),
]
...
T_TG_MS   = 30_000     # cada cuánto vaciar la cola a Telegram
BROADCAST_MAC = b'\xff\xff\xff\xff\xff\xff'

# ════════════════════════════════════════════════
#  PANTALLA
# ════════════════════════════════════════════════
spi = SPI(2, baudrate=20000000, polarity=0, phase=0, sck=Pin(18), mosi=Pin(19))
...
def flush_telegram():
    ...
    try:
        ...
        print("[TG] enviado, code:", r.status_code)
        r.close()
        _cola_tg = []
