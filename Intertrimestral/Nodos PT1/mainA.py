...
# Espera para que ESP-NOW se estabilice
time.sleep_ms(500)
...
# --- I2C para MPU-6050 y GY-906 ---
i2c = I2C(0, scl=Pin(22), sda=Pin(21), freq=100000)

# Detectar qué sensores I2C están conectados
...
# ===========================================
# Formato: "A:ax:ay:az:temp_amb:temp_obj:temp_dht:hum_dht:valor_mq:pct_mq"
