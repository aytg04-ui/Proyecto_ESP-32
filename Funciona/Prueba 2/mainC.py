...
from i2c_recovery import escanear_con_recuperacion   # módulo de recuperación 
...
if modo_dormido == 1: 
    ...
    display.fb_text("Nodo C dormido", 5, 10, st7789.RED) 
...
# --- MQ-135 --- 
# valor_mq se mantiene en -1 si no pasa los filtros, 
# igual que el resto de sensores ausentes. 
UMBRAL_MINIMO_MQ = 400    # Por debajo → pin flotando hacia abajo 
UMBRAL_MAXIMO_MQ = 3800   # Por encima → pin flotando hacia arriba 
UMBRAL_VARIANZA  = 300    # Diferencia max-min; pin flotante es inestable 
...
try: 
    ...
    if lectura_cruda < UMBRAL_MINIMO_MQ: 
        ...
        valor_mq = lectura_cruda   # solo se asigna si pasa todos los filtros 
...
# =========================================== 
display.fb_fill(st7789.BLACK) 
display.fb_text("Nodo C - Multi", 5, 2, st7789.MAGENTA) 
